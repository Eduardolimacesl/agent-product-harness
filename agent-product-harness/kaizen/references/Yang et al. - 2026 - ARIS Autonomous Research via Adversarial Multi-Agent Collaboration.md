...
Ruofeng Yang 1 † , Yongcan Li 1 , Shuai Li 1 , 2 ∗ 1 Shanghai Jiao Tong University 2 Shanghai Innovation Institute {wanshuiyin, joseph\_y, shuaili8}@sjtu.edu.cn † Project Leader ∗ Corresponding Author Project page: https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep
...
| Component                                                                                                     | Scope                                                                                                                                                                                                                                                                                                                                        |
|---------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Skills Workflows Model bridges Tested executors Assurance stack Persistent memory Effort presets Dependencies | More than 65 Markdown-defined files 5 end-to-end (+ full pipeline command) 6 MCP bridges (Codex, Oracle, Claude, Gemini, 3 (Claude Code, Codex CLI, Cursor); 3 adapted 3-stage audit cascade + manuscript quality Per-project research wiki (4 entity types) 4 levels (lite / balanced / max / beast) None for skills; single binary for CLI |
...
- (2) Modular skill files over monolithic agents. Each research capability is defined primarily by a SKILL.md fi le, a plain-text Markdown specification that can be interpreted by multiple LLM-based coding agents, enabling independent development, domain-specific extensions, and component-level updates.
...
The research wiki provides persistent, cross-session memory through four entity typespapers, ideas, experiments, and claims-stored as structured Markdown pages with canonical node IDs. Eight typed relationships (extends, contradicts, addresses\_gap, inspired\_by, tested\_by, supports, invalidates, supersedes) form a lightweight knowledge graph.
...
|------------------------|----------------------|------------------------|---------------------------------------------------------------------------------------------------------------------------|
| 1. Idea Discovery      | Research direc- tion | Ranked idea re- port   | research-lit , idea-creator , novelty-check , experiment-plan                                                             |
...
| 4. Rebuttal            | Paper + reviews      | Paste-ready rebut- tal | rebuttal (7-phase pipeline with 3 safety gates)                                                                           |
...
|--------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Executor platforms Reviewer models GPU backends Venue templates Free-tier API access Community contributions | 3 tested + 3 adapted (6 total) 6+ (GPT, Gemini, GLM, MiniMax, Kimi, DeepSeek) 4 (local, SSH, Vast.ai, Modal) 9 families ModelScope (no paid API keys required) 30+ contributed skills across robotics, hardware, communications, math |
...
1 Readers can find a broader catalog of auto-research systems at https://cadslab.github.io/ Pantheon/ .
...
- UltraWorkers. Claw Code: Public rust implementation of the claw cli agent harness. GitHub repository, 2026. URL https://github.com/ultraworkers/claw-code . Accessed: 202605-03.
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| research-lit arxiv / alphaxiv deepxiv novelty-check idea-creator idea-discovery experiment-bridge run-experiment monitor-experiment check-gpu analyze-results ablation-planner experiment-audit result-to-claim paper-claim-audit proof-checker auto-review-loop research-review paper-plan paper-write paper-figure paper-compile paper-writing auto-paper-improvement-loop rebuttal research-wiki meta-optimize | Literature Literature Literature Literature Ideation Ideation Experiment Experiment Experiment Experiment Analysis Analysis Integrity Integrity Integrity Integrity Review Review Writing Writing Writing Writing Writing Writing Writing Memory Maintenance | No No No Yes Yes Yes Yes No No No No No Yes No Yes No Yes Yes Yes Yes No No Yes Yes Yes No Yes | Multi-source literature survey Paper metadata / LLM-optimized summary Progressive deep literature search Novelty verification against existing work Brainstorm and rank research ideas Full idea discovery pipeline Plan to running code GPU deployment (local/SSH/Vast.ai/Modal) Experiment monitoring and result collection GPU status and process summary Statistical analysis and comparison tables Reviewer-perspective ablation design Evaluation code integrity verification Result-to-claim verdict conversion Zero-context manuscript number audit 20-category theorem verification Multi-round autonomous review GPT-5.4 xhigh deep critique Structural outline + claims matrix Section-by-section L A T EX + sciwrite 5-pass Publication-quality data plots Multi-pass compilation with auto-repair Full W3 pipeline orchestrator Review + visual PDF + auto-revision 7-phase rebuttal with safety gates Persistent knowledge base management Outer-loop harness optimization |
...
| Repository-level   | Reviewer directly inspects the codebase, evalua- tion scripts, and generated outputs through host- provided repository access tools (e.g., claude-code Bash, codex exec ). Used by experiment-audit and paper-claim-audit . |

Table 7: Reviewer context-policy settings (whether the reviewer retains state across rounds).

| Policy      | Description                                                                                                                                                                                                                              |
|-------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Fresh       | Each review round opens a new reviewer thread with no prior context. Used to prevent confirmation bias from previous rounds ( REVIEWER_BIAS_GUARD = true default). Required for paper-claim-audit and the auto-paper im- provement loop. |
| Cross-round | Reviewer retains memory across rounds, can reference previous critiques and verify whether raised issues have been addressed. Used selectively when convergence verifi- cation is more important than independence.                      |